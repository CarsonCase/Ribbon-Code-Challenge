...
import {IOtokenFactory} from "./MockOToken/interfaces/IOtokenFactory.sol";
import {IOtoken} from "./MockOToken/interfaces/IOtoken.sol";
import {IController} from "./MockOToken/interfaces/IController.sol";
import {GammaTypes} from "./MockOToken/interfaces/IController.sol";
import {
    SafeERC20
...
library VaultLifecycle {
        ...
        )
    {
        ...
        // 0 is premium
        return (otokenAddress, 0, strikePrice, delta);
    }
    ...
    /// NOTE changed to always true for ease
    function checkPath(
        bytes calldata swapPath,
